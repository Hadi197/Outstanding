...
def fetch_and_save(endpoint, params, output_file):
    """
    Fetch data from the specified API endpoint and save it to a CSV file.
...
if __name__ == "__main__":
    # Example usage for PKK
    fetch_and_save(
        endpoint="https://phinnisi.pelindo.co.id:9021/api/ordering/pkks/list-pkk",
        params={"page": 1, "record": 100000, "data": "", "sorting": "", "sort_by": "", "process_code": ""},
        output_file="/Users/hadipurwana/Library/CloudStorage/GoogleDrive-purwana.hadi@gmail.com/My Drive/PYTHON/PHINNISI SCRAP/pkk.csv"
    )
